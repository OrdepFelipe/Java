		...
		for (Funcionario verifica : listaFuncionarios) {
			...
			if (verifica.getId() == procuraFuncionario) {
				...
				if (opcSelecionada == 1) {
					...
					verifica.setSalario(varSalarioFuncionario.incrementoSalario(salario));// altero o salario atraves do  metodo incremetoSalario
					System.out.println(verifica.toString());
				} // printa os dados do funcionario com salario atualizado
				else {
